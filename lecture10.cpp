...
// Construct Binnary Tree form Inorder &preorder | Inorder & postorder
...
//print ancestors of node in binary tree
struct node
{
    int data;
    struct node *left;
...
//(find LCA(least common ancestor) of binary tree)
class Solution
{
public:
